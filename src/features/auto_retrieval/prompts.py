...
Make sure that the filter value returned conforms to the correct data type.
Make sure to return only these allowed Filter Operators: EQ, GT, LT, NE, GTE, LTE.
Never return the "CONTAINS" operators.
