MANUAL_EVAL_QA = [
    (
        ...
        """
Based on your query about places to enjoy cold brew coffee, here are several recommendations ranked by relevance:
...
- Helena Avenue Bakery stands out as the top choice due to its strong reputation for both coffee and food, making it ideal for a breakfast or brunch outing.
- Mike's Ice Cream is a fun option if you're looking to combine your coffee experience with a dessert, especially if you enjoy ice cream.
- Roast Coffeehouse and Wine Bar is suitable for those who appreciate a vibrant atmosphere, but it may not be the best choice if you prefer a quieter setting for enjoying your cold brew.

In summary, if your primary focus is on enjoying high-quality cold brew coffee in a pleasant environment, Helena Avenue Bakery is the best option. If you're in the mood for a treat alongside your coffee, Mike's Ice Cream is a great alternative. For a more social experience, consider Roast Coffeehouse, keeping in mind the potential noise level.
